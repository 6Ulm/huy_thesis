...
\begin{lemma}
    ...
    If $(y_t)_t$ is a nonnegative decreasing sequence, $(z_t)_t$ is a nonnegative sequence,
    $a, b > 0$ such that $y_t \leq a z_{t-1} - b z_t$, then
    \begin{align*}
        y_t \leq \frac{(b-a)}{\left( \frac{b}{a} \right)^t - 1} z_0
        - \frac{\left( \frac{b}{a} \right)^t
        - \left( \frac{b}{a} \right)^{t-1} }{\left( \frac{b}{a} \right)^t - 1} z_t.
    \end{align*}
\end{lemma}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
