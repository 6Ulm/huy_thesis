...
\newcommand{\AxisRotator}[1][rotate=0]{%
    ...
    \draw (-54,-5.8) arc (-150:150:1 and 1);%
}
...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \begin{pgfinterruptboundingbox}
      % the following coords. may need to be changed to suit your slides
      \fill <1> [fill=white, opacity=0.8] (1.5,0.3) rectangle (8,2.3);
  \end{pgfinterruptboundingbox}
\end{tikzpicture}
...
\end{enumerate}
\begin{tikzpicture}[remember picture, overlay]
  \node[shift={(3.5cm,-4cm)}] at (current page.center)
...
\begin{enumerate}
  ...
  \begin{tikzpicture}[remember picture, overlay]
    \node[shift={(5.8cm,-4cm)}] at (current page.center)
...
\begin{minipage}[t]{0.6\linewidth}
  \begin{itemize}
    ...
    \end{align*}
    \begin{tikzpicture}[remember picture, overlay]
      \node[shift={(4cm,2cm)}] at (current page.center)
    ...
    \begin{align*}
      ...
      \end{align*}
      \begin{tikzpicture}[remember picture, overlay]
      \node[shift={(4.3cm,-1cm)}] at (current page.center)
