...
\begin{frame}{Cross-domain alignment}
  ...
  \begin{figure}
    ...
    \vspace{-0.5cm}
    \caption*{\scriptsize{Examples of cross-domain alignment: machine translation \parencite{Peyre16},
    image-text summary \parencite{Peyre16}, cell alignment \parencite{Peyre16}}}
  \end{figure}
  ...
  % \begin{tikzpicture}[remember picture, overlay]
  %   \node[shift={(-3.5cm,-1.75cm)}, text width=0.25\linewidth] at (current page.center)
  %   {\tiny{Machine translation \parencite{Peyre16}}};
  % \end{tikzpicture}

  % \begin{tikzpicture}[remember picture, overlay]
  %   \node[shift={(0.5cm, -1.75cm)}, text width=0.25\linewidth] at (current page.center)
  %   {\tiny{Image-text summary \parencite{Peyre16}}};
  % \end{tikzpicture}

  % \begin{tikzpicture}[remember picture, overlay]
  %   \node[shift={(3.5cm, -1.75cm)}, text width=0.25\linewidth] at (current page.center)
  %   {\tiny{Cell alignment \parencite{Peyre16}}};
  % \end{tikzpicture}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Extension 2: Shared space (1)}
  \begin{figure}
    \centering
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Extension 2: Shared space (2)}
  \scriptsize
  \begin{definition}[(Informal) Fused GW \parencite{Vayer19b}]
