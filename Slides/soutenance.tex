...
\begin{frame}
  ...
  % \begin{figure}
  %   \centering
  %   \includegraphics[width=1.2\linewidth, keepaspectratio=true]{OT_new/gww.pdf}
  % \end{figure}
  \begin{tikzpicture}[remember picture, overlay]
...
\begin{frame}{Summary of contributions (1)}
  ...
  \begin{tikzpicture}[remember picture, overlay]
    \node[shift={(0cm,-4.4cm)}] at (current page.center)
...
\begin{frame}{Summary of contributions (3)}
  ...
  \begin{tikzpicture}[remember picture, overlay]
    \node[shift={(0cm,-4.3cm)}] at (current page.center)
...
\begin{enumerate}
  ...
  \begin{tikzpicture}[remember picture, overlay]
    \node[shift={(5.5cm,-3cm)}] at (current page.center)
...
\begin{frame}
  ...
  \begin{tikzpicture}[remember picture, overlay]
    \node[shift={(0cm,-0.5cm)}] at (current page.center)
