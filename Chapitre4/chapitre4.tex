...
This paper presents the results from the paper \citep{Thual22} and addresses the unbalanced extension
...
In this work, I work on the formulation, the algorithm and its implementation.
The experiments on the data are done by Alexis Thual.
