...
\Cref{tab:hda_agw} presents the performance of each method averaged across ten runs in
...
\paragraph{Empirical runtime} As described in \Cref{subsec:agw_formulation},
