...
(1) unbalanced datasets where samples or features are re-weighted
...
As a consequence of \Cref{prop:uot_minimizer}, UCOOT is a bilinear function of its minimizers,
thanks to the property of the KL divergence. More precisely,
