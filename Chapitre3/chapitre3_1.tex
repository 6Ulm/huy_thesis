...
the theoretical and practical properties, namely \Cref{prop:existence}
...
Thanks to \Cref{prop:uot_minimizer}, we can show that UCOOT is a bilinear function of its minimizers
