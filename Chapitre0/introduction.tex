...
\begin{enumerate}
    \item Given the discrete nature of COOT, it is natural to study of its continuous extension,
    which may serve as the first step towards further analysis on the numerical,
    and potentially, statistical properties. Given the close connection between COOT and GW,
    understanding one may shed light on understanding the other. Related works:
    \begin{itemize}
        \item[$\bullet$] \Cref{chap:coot} of this thesis.
        \item[$\bullet$] \underline{Unbalanced Co-Optimal Transport}. \textbf{Quang Huy Tran},
        ...
        \item[$\bullet$] \underline{Factored couplings in multi-marginal optimal transport via difference of
    ...
    thus can provide efficient solution to a specific problem.
    Examples of this strategy include the unbalanced GW \citep{Sejourne20}
    and fused GW \citep{Vayer19b}. Related works:
    \begin{itemize}
