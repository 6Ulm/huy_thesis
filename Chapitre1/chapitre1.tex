...
\begin{figure}[ht]
  ...
  \caption{"W" indicates the \textit{Wassersteinization} process defined by replacing the optimization over the correspondances by over the admissible couplings.
...
to reconstruct the coupling, as in the Sinkhorn-based methods. Following the work of \citet{Chapel21},
