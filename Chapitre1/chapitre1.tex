...
squared $l_2$-regularized UOT problem \eqref{uot_l2} (see \Cref{coro:uot_l2_minimizer}),
...
\eqref{eq:discrete_ent_uot}, it is also possible to express the minimum of Problem \eqref{uot_l2}
as a quadratic function of its minimizer.
\begin{corollary}
