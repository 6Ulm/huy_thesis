...
In particular, we focus on the computational and practical aspects,
which are not usually discussed in the OT literature. By contrast,
we only briefly present the theory since it has been well-studied and can be found easily
...
Then, we briefly present some theoritical properties of the Wasserstein distance,
...
The computation can be further speed up by exploiting the structure of the kernel matrix
...
or the greedy approach \citep{Altschuler17,Lin20,Kostic21}, tend to rely on careful elaboration
of the iterates. There exist also other classes of algorithms for the entropic OT, notably
