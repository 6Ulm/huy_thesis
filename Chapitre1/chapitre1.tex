...
By contrast, we only briefly present the theory since it has been well-studied and can be found
easily in many prior works, which will be precised during the discussion of each topic.
...
or the greedy approach \citep{Altschuler17,Lin20,Kostic21}, usually rely on careful elaboration
