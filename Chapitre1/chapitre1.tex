...
\footnote{See Section 4.3 in \citep{Peyre19} and the excellent thesis of \citep{Feydy20} for more
...
Sinkhorn algorithm \citep{Khiem20}. We remark that, \Cref{prop:uot_minimizer} has a broad range of
applications, from the unregularized UOT (\ie, $\varepsilon = 0$) to other unbalanced divergences,
...
To solve this regularized problem, \citep{Peyre16,Solomon16} propose to use projected gradient descent,
