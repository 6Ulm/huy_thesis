...
\begin{proof}[Proof of \Cref{prop:basic_prop}]
  ...
  \begin{align}
      \alpha \langle L(D_X, D_Y) \otimes P_1, P_1 \rangle
      &\leq \alpha \langle L(D_X, D_Y) \otimes P_{\alpha}, P_{\alpha} \rangle
      + (1 - \alpha) \langle L(X, Y) \otimes Q_{\alpha}, P_{\alpha} \rangle \\
      &\leq \alpha \langle L(D_X, D_Y) \otimes P_1, P_1 \rangle
  ...
  \begin{align}
      ...
      &\leq (1 - \alpha) \coot(\cX, \cY) + \alpha \langle L(D_X, D_Y) \otimes P_0, P_0 \rangle.
  \end{align}
  ...
  \begin{align}
      ...
      \frac{P^{XY}_{i,e} P^{YZ}_{e,k}}{(\mu_1^Y)_e}
      \frac{Q^{XY}_{j,o} Q^{YZ}_{o,l}}{(\mu_2^Y)_o} \\
      &= \alpha \sum_{i,j,e,o} |D_X(i,j) - D_Y(e,o)|^2 P^{XY}_{i,e} P^{XY}_{j,o}
      + (1 - \alpha) \sum_{i,j,e,o} |X_{i,j} - Y_{e,o}|^2 P^{XY}_{i,e} Q^{XY}_{j,o} \\
      &+ \alpha \sum_{k, l, e, o} |D_Y(e, o) - D_Z(k,l)|^2 P^{YZ}_{e,k} P^{YZ}_{o,l}
...
\begin{proof}[Proof of \Cref{corr:hermitian}]
  This proof is based on the personal communication with Professor Will Sawin at Princeton University
  ...
  We thank him for his very prompt and detailed support during the submission of our paper.
...
\begin{proof}[Proof of \Cref{thm:invariant}]
  ...
  $\langle L(D_X,D_Y)\otimes P^*, P^* \rangle = 0$ and
