...
\paragraph{Alternative proof.} Suppose $n > d$, then $P A A^T = A Q A^T$. As $P \in \cP_n$, we have
\begin{align}
...
In summary, we can determine $Q \in \cO_d$ such that $QS = SQ$ as follows: since $S$ is orthogonally diagonalizable,
